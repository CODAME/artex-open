...
// Source: rafaelamascaro_1772050284_3840553445376461250_17840494.mp4
// MD5: c04d8ad533f15fe2873db3b9dfccdc96

const vec3 VIDEO_BASE = vec3(0.439774, 0.420135, 0.687152);
const vec3 VIDEO_ACCENT = vec3(0.651980, 0.751486, 0.880605);
const vec3 VIDEO_SHADOW = vec3(0.259841, 0.068313, 0.100065);
const float VIDEO_PULSE = 2.195294;
const float VIDEO_SWIRL = 0.770000;
const float VIDEO_GRAIN = 0.623529;
const float VIDEO_TILT = -0.417255;
const float VIDEO_STROBE = 1.270000;
const float VIDEO_DRIFT = 0.946102;
